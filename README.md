[![Run App Wongsawat Srisa-an](https://github.com/wsrisa-an/GithubActions/actions/workflows/run-app.yaml/badge.svg)](https://github.com/wsrisa-an/GithubActions/actions/workflows/run-app.yaml)
